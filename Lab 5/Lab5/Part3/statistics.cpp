...
void printArray( int array[], int size, std::string arrayName ) {
...
int main( int argc, char* argv[] ) {
  ...
  cerr  << "dlist's find cost = " << dlist.getCost( ) << endl;
  ...
  cerr << "mtflist's find cost = " << mtflist.getCost( ) << endl;
  ...
  cerr << "translist's find cost = " << translist.getCost( ) << endl;
